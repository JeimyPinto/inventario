...
class UserData
{
	...
	public function add()
	{
		$sql = "insert into user (name,lastname,username,email,is_admin,password,created_at) values (\"$this->name\",\"$this->lastname\",\"$this->username\",\"$this->email\",\"$this->is_admin\",\"$this->password\",$this->created_at)";
	...
	public static function getById($id)
	{
		...
		$query = Executor::execute($sql); // Cambia doit por execute
		$found = null;
		$data = new UserData();
